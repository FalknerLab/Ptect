...
def find_files(root_dir: str, targets=None):
    """
    Finds all files, recursively, in the given root directory.
...
if __name__ == '__main__':
    ...
    find_rename_cam_videos(r'D:\LSpaper\behavior_data\CMM')
    # find_rename_cam_videos(r'D:\ephys_data\DAE012\Day4\npx2territory_self_dae012_other_dab035_day_4_block_2_orientation_rni_20250314_131308', cam_dict={'top':'top', 'side1':'side1', 'side2':'side2', 'side3':'side3'})
