...
if __name__ == '__main__':
    ...
    find_rename_cam_folders('D:\\ptect_dataset\\AggExp\\real\\data')
    find_rename_cam_videos('D:\\ptect_dataset\\AggExp\\real\\data', cam_dict={'top':'top', 'side1':'side1', 'side2':'side2', 'side3':'side3'})
